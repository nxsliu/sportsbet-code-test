...
public class RaceTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task Given_ValidUpdateRequest_UpdateRace_ReturnsSuccess()
    {
        ...
        FakeDataStore.Races.Add(existingRace.ExternalRaceId, existingRace);
        ...
        // assert
        response.EnsureSuccessStatusCode();
        Assert.Equal(1111, FakeDataStore.Races[1111].ExternalRaceId);
        Assert.Equal(5, FakeDataStore.Races[1111].InternalRaceId);
        var jsonString = "{\"RaceId\":5,\"RaceLocation\":\"Malvern\",\"Distance\":5000,\"RaceNumber\":10,\"RaceType\":\"Country\",\"RaceInfo\":\"Mushroom Cup\",\"TrackCondition\":\"Bad(8)\",\"StartTimeUtc\":\"2023-10-20T20:15:00Z\",\"Runners\":[{\"Id\":222,\"Number\":5,\"Barrier\":12,\"Name\":\"FRANCE\",\"WinPrice\":5.5,\"Jockey\":\"Mark Andersen\",\"Trainer\":\"L J Hoooker\"}]}";
